  ...
  return (
    <section className="flex flex-col bg-primary px-5 py-32 text-white" id="contact"> 
      <div className="flex flex-col items-center">
        ...
        <p className="py-2"><span className="font-bold">Email : </span>vigneshkumarb.sc2004@gmail.com</p>
        <p className="py-2"><span className="font-bold">Phone : </span>7010722215</p>
      </div>
    </section>
  );
};
